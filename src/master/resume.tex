...
\begin{document}
	...
	\noindent {\bf Qualifications}  $\bullet$ Used math and theory to derive algorithms that I implemented, tested, and optimized.
	$\bullet$ Adept at learning new tools, technologies, and paradigms.
